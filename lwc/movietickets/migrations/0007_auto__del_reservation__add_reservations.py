...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'movietickets_reservation')
        ...
        db.create_table(u'movietickets_reservations', (
            ...
            ('no_of_seats', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('amount_paid', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'movietickets_reservation', (
            ('phone_number', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('amount_paid', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('date', self.gf('django.db.models.fields.DateField')(null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'movietickets', ['Reservation'])
